...
export function boom(){
	console.log("BOOM NOT CAUSING AN ISSUE");
}

export function getAudio(callback) { 				// Get mic access and connect it up
	console.log("Get Audio got called");
